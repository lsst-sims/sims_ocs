...
.. list-table:: 
    ...
    * -  groupId
      -  Group Id for the target. This is non-zero and repeated for field/filter combinations collected in sets of N (tuples or sequences). It is zero when N equal one.
    * -  filter
    ...
    * -  cloud
      -  The fraction of clouds (0: none to 1: total) for the target.
    * -  seeing
      -  The seeing (units=arcseconds) for the target.
    * -  slewTime
      -  The calculated slew time (units=seconds) for the target.
    * -  cost
      -  The calculated cost for the target.
    * -  rank
