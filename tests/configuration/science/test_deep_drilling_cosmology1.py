...
class DeepDrillingCosmology1Test(unittest.TestCase):
    ...
    def test_basic_information_after_creation(self):
        ...
        self.assertEqual(self.prop.sub_sequences[1].time_window_start, -0.2)
    ...
    def test_set_topic(self):
        ...
        self.assertListEqual(list(out_topic.sub_sequence_time_window_starts)[:nss], [-0.2, -0.2])
        self.assertListEqual(list(out_topic.sub_sequence_time_window_maximums)[:nss], [0.5, 0.5])
        self.assertListEqual(list(out_topic.sub_sequence_time_window_ends)[:nss], [0.7, 0.7])
