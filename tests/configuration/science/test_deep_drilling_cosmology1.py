...
class DeepDrillingCosmology1Test(unittest.TestCase):
    ...
    def test_basic_information_after_creation(self):
        ...
        self.assertEqual(self.prop.sub_sequences[1].time_window_start, 0.0)
        self.assertEqual(self.prop.sub_sequences[0].time_window_max, 0.7)
        self.assertEqual(self.prop.sub_sequences[1].time_window_end, 0.9)
    ...
    def test_set_topic(self):
        ...
        self.assertListEqual(list(out_topic.sub_sequence_time_window_maximums)[:nss], [0.7, 0.7])
        self.assertListEqual(list(out_topic.sub_sequence_time_window_ends)[:nss], [0.9, 0.9])
