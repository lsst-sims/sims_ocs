...
class SlewTest(unittest.TestCase):
    ...
    def test_array_setting(self):
        self.slew.set_array(self.slew_conf, "tel_optics_alt_limit")
        self.assertEqual(len(self.slew_conf.tel_optics_alt_limit), 3)
        self.assertEqual(self.slew_conf.tel_optics_alt_limit[2], 90.0)
